                ...
                <div class="page-with-aside mail-wrapper bg-white">
                    <div class="page-aside bg-grey1">
                        ...
                        <div class="aside-nav collapse" id="email-app-nav">
                            ...
                            <div class="aside-compose"><a href="#"
                                    class="btn btn-primary btn-block fw-mediumbold">Compose Email</a></div>
                        </div>
                    </div>
                                ...
                                <div class="email-filters-left">
                                    ...
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" type="button"
                                            class="btn btn-secondary btn-border dropdown-toggle"> With selected
                                        </button>
                                        <div role="menu" class="dropdown-menu"><a href="#"
                                                class="dropdown-item">Mark as read</a><a href="#"
                                                class="dropdown-item">Mark as unread</a><a href="#"
                                                class="dropdown-item">Spam</a>
                                    ...
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" type="button"
                                            class="btn btn-secondary btn-border dropdown-toggle" aria-expanded="false">Order
                                            by </button>
                                        <div role="menu" class="dropdown-menu dropdown-menu-right"><a href="#"
                                                class="dropdown-item">Date</a><a href="#"
                                                class="dropdown-item">From</a><a href="#"
                                                class="dropdown-item">Subject</a>
                                            <div class="dropdown-divider"></div><a href="#"
                                                class="dropdown-item">Size</a>
                                        </div>
                                    </div>
                                </div>

                                <div class="email-filters-right ml-auto"><span class="email-pagination-indicator">1-50
                                        of 213</span>
                                    <div class="btn-group ml-3">
                                        <button type="button" class="btn btn-secondary btn-border"><i
                            ...
                            <div class="email-list">
                                <div class="email-list-item unread">
                                    ...
                                    <div class="email-list-detail">
                                        <span class="date float-right"><i class="fa fa-paperclip paperclip"></i> 28
                                            Jul</span><span class="from">Google Webmaster</span>
                                ...
                                <div class="email-list-item unread">
                                    ...
                                    <div class="email-list-detail"><span class="date float-right"></span><span
                                            class="date float-right"><i class="fa fa-paperclip paperclip"></i>
                                            13
                                            Jul</span><span class="from"> PHPClass</span>
                                ...
                                <div class="email-list-item">
                                    ...
                                    <div class="email-list-detail"><span class="date float-right">23
                                            Jun</span><span class="from">Language Course</span>
                                ...
                                <div class="email-list-item">
                                    ...
                                    <div class="email-list-detail"><span class="date float-right">17
                                            May</span><span class="from">Farrah Septya</span>
                                ...
                                <div class="email-list-item">
                                    ...
                                    <div class="email-list-detail"><span class="date float-right">16
                                            May</span><span class="from">Facebook</span>
                                ...
                                <div class="email-list-item">
                                    ...
                                    <div class="email-list-detail"><span class="date float-right">12
                                            May</span><span class="from">Kristopher Donny</span>
